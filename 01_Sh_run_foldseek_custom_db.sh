...
#FOLDSEEK_DB=/lus/lfs1aip2/scratch/s5h/omeir.s5h/databases/runs_n_poses/foldseek_db/rnp_db
#CUSTOM_DB=/lus/lfs1aip2/scratch/s5h/omeir.s5h/databases/runs_n_poses/
CUSTOM_DB=/scratch/s5h/omeir.s5h/databases/fragalysis_foldseek/A71EV2A_2026-02-04
FOLDSEEK_DB=/scratch/s5h/omeir.s5h/databases/fragalysis_foldseek/A71EV2A_2026-02-04/foldseek_db/a71ev2a_db
...
python3 Py_calc_pocket_qcov.py -i_foldseek=${OUT_DIR}/d3i_foldseek_aln_${pdb_n}.tsv -i_mmseqs=${OUT_DIR}/d3i_mmseqs_aln_${pdb_n}.tsv -pdb=${INP_PDB} -sdf=${INP_SDF} -o=${OUT_DIR}/qcov_${pdb_n}.tsv -c ${CUSTOM_DB}

python3 Py_calc_sucos.py -q=${OUT_DIR}/qcov_${pdb_n}.tsv  -sdf=${INP_SDF} -o=${OUT_DIR}/sucos_qcov_${pdb_n}.tsv -c ${CUSTOM_DB}
